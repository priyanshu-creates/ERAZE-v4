...
export default function NIS2Page() {
  ...
  return (
    ...
    <div className="min-h-screen">
      {/* Hero Section - Introduction to the NIS2 service */}
        ...
        <div className="max-w-[1440px] mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-[clamp(24px,3vw,48px)] font-normal text-[#FFFFFF] leading-[1.2] mb-8">
              Navigate the journey to NIS2 compliance with our expert services, guiding organizations to achieve high cybersecurity standards.
            </p>
          </div>
        </div>
      </section>
