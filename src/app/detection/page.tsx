...
// Detection and Response service page component
export default function DetectionPage() {
  ...
  // Define offerings data for the specific service offerings
  // These are the specific solutions within the Detection and Response service
  const offerings = [
    {
      id: "1.0",
      title: "Hyperautomation 10X Faster Incident Response",
      description: "We transform SOC operations through hyperautomation, leveraging best-of-breed next-generation SOAR platforms to automate incident responses and accelerate threat remediation."
    },
    {
      id: "2.0",
      title: "SIEM augmentation Unleash Your SIEM Potential",
      description: "Leveraging two decades of SIEM expertise, we augment your security operations by deploying advanced analytics and custom detections aligned with your specific business requirements."
    },
    {
      id: "3.0",
      title: "Threat Hunting Discover the Undetected",
      description: "We bring together our expertise in top SIEM and threat intelligence technologies with SOAR automation and AI to provide a fully integrated threat hunting service."
    }
  ];
  ...
  return (
    ...
    <div className="min-h-screen">
      {/* Hero Section - Introduction to the Detection and Response service */}
      ...
      {/* Offerings Section - Specific solutions within this service */}
      <section className="py-20">
        ...
        <div className="max-w-[1440px] mx-auto px-6">
          ...
          <div className="text-center mb-16">
            {/* Section tagline */}
            <p className="text-sm text-[#666666] mb-2 uppercase tracking-[0.1em]">[ our services ]</p>
            {/* Section title */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Map through offerings array to create offering cards */}
            {offerings.map((offering) => (
              // Offering card with styling and hover effects
              <div key={offering.id} className="bg-[rgba(31,41,55,0.3)] backdrop-blur-sm border border-[rgba(127,255,0,0.2)] rounded-[24px] p-10 min-h-[400px] transition-all duration-300 card-hover">
                {/* Offering ID tag */}
                <p className="text-sm text-[#666666] mb-2 uppercase tracking-[0.1em]">[ {offering.id} ]</p>
                {/* Offering title */}
